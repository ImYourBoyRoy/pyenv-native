// ./crates/pyenv-core/src/self_update.rs
...
const DEFAULT_GITHUB_REPO: &str = "imyourboyroy/pyenv-native";
...
fn parse_semverish(value: &str) -> ParsedVersion {
...
mod tests {
    ...
    use super::{
        compare_release_versions, fetch_latest_release_info, normalize_tag, parse_semverish,
    };
