...
pub(super) const CORE_COMMAND_DOCS: &[CommandDoc] = &[
    ...
    CommandDoc {
        ...
        help: &[
            ...
            "",
            "Examples:",
            "  pyenv local 3.14.7     Set the local version to 3.14.7",
            "  pyenv local 3.12        Set local to the latest installed 3.12.x",
            "  pyenv local 3.14.7/envs/app   Bind the directory to a managed venv",
    ...
    CommandDoc {
        ...
        help: &[
            ...
            "",
            "Examples:",
            "  pyenv global 3.14.7       Set the global version to 3.14.7",
            "  pyenv global 3.12          Set global to the latest installed 3.12.x",
            "  pyenv global 3.14.7/envs/tooling  Make a managed venv the global default",
    ...
    CommandDoc {
        ...
        help: &[
            ...
            "",
            "Examples:",
            "  pyenv shell 3.14.7       Use 3.14.7 in this shell session only",
    ...
    CommandDoc {
        ...
        help: &[
            ...
            "  pyenv install 3.14.7             Install CPython 3.14.7",
            ...
            "  pyenv install -f 3.14.7          Force reinstall 3.14.7",
            "",
